...
class Quiz:
    ...
    # otherwise shows next question or back button.
    def next_btn(self):
    ...
    def buttons(self):
        ...
        # The secodn button is the Back button and goes to the previous question
        back_button = Button(gui, text="Back", command=self.back_btn,
                             width=10, bg="dark olive green", fg="white", font=("ariel", 16, "bold"))
        # The placement of the button
        back_button.place(x=200, y=380)                     
